...
if __name__ == "__main__":
    ...
    parser.add_argument("--target_model_dir",  type=str,   default=os.path.join("trained_output", "cnn_gap_b64_lr0.01"), help="Directory containing the trained model files")
    parser.add_argument("--target_epoch",      type=int,   default=8, help="Epoch number of the model to test")
