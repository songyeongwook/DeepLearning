...
from models.grucopy import GRU
...
def main(args):
    ...
    # model = LSTM(dimension=args.dimension,
    #              hidden_size=args.hidden_size,
    #              num_layers=args.num_layers,
    #              num_classes=args.num_classes,
    #              device=device)
    
    model = GRU(dimension=args.dimension,
                 hidden_size=args.hidden_size,
                 num_layers=args.num_layers,
                 num_classes=args.num_classes,
                 device=device)
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--target_model_dir", type=str,   default="trained_output/lstm_mnist_b32_lr0.001_h64_l1" )
    parser.add_argument("--target_model_dir", type=str,   default="trained_output/gru_mnist_b256_lr0.001_h128_l4" )
    parser.add_argument("--target_epoch",     type=int,   default=18,     help="Epoch number of the model to test")
