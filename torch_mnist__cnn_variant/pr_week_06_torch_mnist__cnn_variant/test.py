...
# from models.cnn_residual  import CNN
...
if __name__ == "__main__":
    ...
    parser.add_argument("--target_model_dir",  type=str,   default="trained_output\cnn_strided_depthwise_dilated_gap_b32_lr0.01", help="Directory containing the trained model files")
    parser.add_argument("--target_epoch",      type=int,   default=10, help="Epoch number of the model to test")
