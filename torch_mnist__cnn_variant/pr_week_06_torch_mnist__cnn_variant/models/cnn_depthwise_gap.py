...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.dw_conv1 = nn.Conv2d(in_channels=1, out_channels=1, kernel_size=3, stride=1, padding=1, groups=1)
        ...
        self.dw_conv2 = nn.Conv2d(in_channels=32, out_channels=32, kernel_size=3, stride=1, padding=1, groups=32)
