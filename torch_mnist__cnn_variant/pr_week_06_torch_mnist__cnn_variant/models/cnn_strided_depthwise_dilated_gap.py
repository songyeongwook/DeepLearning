...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.dw_conv1 = nn.Conv2d(in_channels=1, out_channels=1, kernel_size=3, stride=2, padding=0, groups=1, dilation=2)
        self.pw_conv1 = nn.Conv2d(in_channels=1, out_channels=32, kernel_size=1)
        self.bn1 = nn.BatchNorm2d(32)

        # Second Convolutional Layer (Depthwise Separable)
        self.dw_conv2 = nn.Conv2d(in_channels=32, out_channels=32, kernel_size=3, stride=2, padding=0, groups=32, dilation=2)
