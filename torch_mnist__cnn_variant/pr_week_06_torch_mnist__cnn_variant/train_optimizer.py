...
# from models.cnn_gap import CNN #global average pooling
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_name", type=str,   default="cnn_depthwise_gap_b32_lr0.01", help="base name for the output directory")
